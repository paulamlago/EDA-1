...
public:
	...
	*/
	...
	void añadeLista(Cola<T> c2) {
        Nodo *_auxC1 = _prim, *_auxC2 = c2._prim;
        Nodo *_guarC1, *_guarC2;

        if (_auxC2->_elem < _auxC1->_elem) {
            _guarC1 = _prim;
            _prim = c2._prim;
            c2._prim = c2._prim->_sig;
            _prim->_sig = _guarC1;
        }
        _auxC2 = c2._prim;
        _auxC1 = _prim;
        while (!c2.esVacia()) {
            if (_auxC1->_sig = _ult) {
                _ult = c2._prim;
                _auxC1->_sig->_sig = _ult;
                
                c2._prim = nullptr;
            }
            else if (_auxC1->_sig->_elem < _auxC2->_elem) {
                _auxC1 = _auxC1->_sig;
            }
            else {
                _guarC1 = _auxC1->_sig;
                _auxC1->_sig = _auxC2;
                c2._prim = _auxC2->_sig;
                _auxC2->_sig = _guarC1;
                _auxC1 = _auxC1->_sig;
                _auxC2 = c2._prim;
            }
