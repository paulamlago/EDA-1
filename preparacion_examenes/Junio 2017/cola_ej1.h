...
public:
	...
	*/
	...
	/* Desplaza el elemeto pos, desp posiciones a la izquierda */
	void desplaza(int pos, int desp){
		...
		Nodo *elemO = orig->_sig;
		Nodo *elemD = dest->_sig;

		orig->_sig = elemO->_sig;
		elemO->_sig = elemD;
		dest->_sig = elemO;
